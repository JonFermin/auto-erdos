...
status: open
depends_on: [chain_locality_triple, chain_locality_sketch]
...
proof of `chain_locality_triple`. The proof is *near-complete* because one case
...
The CHECK in `lemma_chain_locality_triple.md` showed that for some spanning trees of
