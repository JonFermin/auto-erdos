...
status: open
depends_on: [chain_locality_triple]
...
This lemma attempts to close the formal-proof gap for `chain_locality_triple`
...
sym-diff has length 8. The CHECK in `lemma_chain_locality_triple.md` confirms this holds
...
The pairwise falsification example (from `lemma_chain_locality_triple.md`):
