...
This extends Lemma `chain_locality_triple` (which covered all min-degree-3 graphs with
...
`lemma_chain_locality_triple.md`). For $n \ge 12$ cubic graphs in this sample, most
